      ...
      <div className="min-h-[calc(100dvh-64px)] p-2 sm:p-6 md:p-12 pb-32 flex flex-col items-center">
        <div className="w-full max-w-4xl space-y-6 sm:space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-8 items-start">
            ...
            {/* Mobile Horizontally Scrollable Pills (Horizontal scroll restored) */}
            <div className="flex overflow-x-auto no-scrollbar gap-2 pb-2 w-full md:hidden">
              {tabOptions.map((tab) => (
                <button
                  key={tab.id}
                  onClick={() => {
                  ...
                  className={cn(
                    "flex items-center gap-2 px-4 py-2.5 rounded-xl font-space font-black text-[10px] uppercase border tracking-wider transition-all duration-300 shrink-0 justify-center whitespace-nowrap",
                    activeTab === tab.id
            ...
            <div className="col-span-1 md:col-span-3 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl px-4 py-6 md:p-8 shadow-2xl min-h-[460px] flex flex-col justify-between relative overflow-hidden">
                ...
                >
                  ...
                  {activeTab === 'ACCOUNT' && (
                    <div className="space-y-6">
                      {/* Redundant header commented out for mobile settings redesign
                      ...
                      */}
                      ...
                      <div className="space-y-6">
                        ...
                        */}
                        ...
                        {/* Distinct full-width LOGOUT button at the absolute bottom of Account tab */}
                        <div className="pt-6 border-t border-zinc-800/50">
                          <button
                            ...
                            className="w-full py-3.5 px-5 border border-red-900/30 text-red-400 hover:bg-red-950/20 transition-all font-space font-black text-xs uppercase tracking-widest rounded-xl text-center cursor-pointer font-bold"
                          >
                            {t('logout')}
                          </button>
                        </div>
              ...
              {/* Symmetrical Settings panel action footer commented out for sticky bottom bar & Account tab logout redesign
      ...
      <div className="fixed bottom-0 left-0 w-full p-4 bg-zinc-950/80 backdrop-blur-md border-t border-zinc-800 z-40 flex items-center justify-center">
        <div className="w-full max-w-4xl flex justify-end px-4">
          <button
            ...
            onClick={handleSave}
            disabled={saving}
            className="w-full md:w-auto bg-teal-600 text-white hover:bg-teal-500 px-8 py-3.5 font-space font-black text-xs uppercase tracking-[0.2em] shadow-lg shadow-teal-500/20 hover:shadow-teal-500/40 hover:scale-[1.01] active:scale-[0.99] transition-all disabled:opacity-50 rounded-lg cursor-pointer text-center font-bold"
          >
            {saving ? (isRTL ? 'جاري الحفظ...' : 'SAVING...') : t('save')}
          </button>
        </div>
