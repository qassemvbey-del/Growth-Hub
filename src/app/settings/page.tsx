        ...
        {isRanksRoadmapOpen && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[99999] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-white/5 pb-4 mb-4">
                <div className="text-start">
                  ...
                  <p className="text-[8px] font-space tracking-[0.2em] uppercase font-black mt-1" style={{ color: currentTheme.color }}>
                    {isRTL ? 'مستوى تقدمك ورتب النظام' : 'SYSTEM_PROGRESSION_TIERS'}
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="flex-1 overflow-y-auto pe-1 space-y-3 scrollbar-thin text-start">
                {RANKS_DATA.map((rank) => {
                  ...
                  return (
                    <div
                      ...
                      style={isUnlocked ? { borderColor: `${rank.color}30` } : {}}
                    >
                      {/* Left Side: Trophy & Info */}
                      <div className="flex items-center gap-4">
                        <div
                          className="w-10 h-10 rounded-full border flex items-center justify-center bg-white/5"
                          style={{ borderColor: isUnlocked ? `${rank.color}40` : 'rgba(255,255,255,0.05)' }}
                        >
                          <Trophy className="w-5 h-5" style={{ color: isUnlocked ? rank.color : '#71717a' }} />
                        </div>
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {isUnlocked && (
                              <span className="text-[9px] font-space font-black px-1.5 py-0.5 rounded bg-green-500/20 text-green-400 border border-green-500/30 uppercase tracking-widest">
                      ...
                      {/* Right Side: Lock Icon for locked ranks */}
                      {!isUnlocked && (
